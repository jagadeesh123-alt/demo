...
<img width="1042" alt="petclinic-screenshot" src="https://github.com/lakshmojirao999/mypetclinic/blob/master/petclinic_app-main-screen.JPG">
...
For pull requests, editor preferences are available in the [editor config](.editorconfig) for easy use  common text editors. Read more and download plugins at <http://editorconfig.org>.
